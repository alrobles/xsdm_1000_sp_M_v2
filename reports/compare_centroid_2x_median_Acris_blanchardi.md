...
- En la matriz 25/50/75/100 %, `centroid` con el buffer por defecto dio ~0.52, mucho más alto que este smoke. La diferencia clave aquí es el buffer `2x_median` (más pequeño) y el submuestreo al 10 %.
