#!/bin/bash
# orchestrate_v8.sh — Multi-phase orchestrator for xsdm v8 (ecoregion M, new pseudoabsence sampling)
...
# v8 inputs are prepared per species in outputs_v8/<species>/ (CSV time series + M/M_buffer shapefiles)
RESULTS_DIR="${RESULTS_DIR:-${REPO_ROOT}/outputs_v8}"
ENV_CSV_DIR="${ENV_CSV_DIR:-${REPO_ROOT}/outputs_v8}"
LOGS_DIR="${LOGS_DIR:-${REPO_ROOT}/logs/orchestrator_v8}"
