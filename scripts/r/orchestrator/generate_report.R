...
#
# Consumes the artefacts produced by orchestrate_v6.sh for one species:
#   <species_dir>/models/*.rds           (fit_single_model.R outputs)
#   <species_dir>/wb/*_wb.rds            (check_well_behaved.R outputs)
#   <species_dir>/profile_results_v6.rds  (run_profile.R output)
#   <species_dir>/plots/profile_likelihood_v6.png
#   <species_dir>/plots/habitat_suitability_v6.png
...
bicaic_rel <- file.path("plots", "bic_vs_aic_v6.png")
...
rpt("")
prof_file <- file.path(species_dir, "profile_results_v6.rds")
...
tss_file <- file.path(species_dir, "tss_results_v6.rds")
...
png_rel <- file.path("plots", "profile_likelihood_v6.png")
...
hab_rel <- file.path("plots", "habitat_suitability_v6.png")
hab_abs <- file.path(species_dir, hab_rel)
hab_bin_rel <- file.path("plots", "habitat_suitability_binary_v6.png")
